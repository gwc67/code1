...
opts =struct('output_dir','excel_csv\zhen','output_name','kp=0.18-ki=0.1-kd=0.3');
my_flitter("excel_csv\kp=0.18-ki=0.1-kd=0.3.csv",opts)
...
% my_pid_analyze("excel_csv\kp=0.18-ki=0.1-kd=0.3.csv",opts);
plot_radar_3d('excel_csv\zhen\kp=0.18-ki=0.1-kd=0.3.csv');
