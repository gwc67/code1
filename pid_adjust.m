...
opts =struct('output_dir','excel_csv/kkp=0.1--ki=0.06--kd=0.2_2','output_name','kp=0.1--ki=0.06--kd=0.2_2');
my_flitter("excel_csv/kp=0.1--ki=0.06--kd=0.2_2.csv",opts)
...
my_pid_analyze("D:\Documents\MATLAB\code1\excel_csv\kkp=0.1--ki=0.06--kd=0.2_2\kp=0.1--ki=0.06--kd=0.2_2.csv",opts);
